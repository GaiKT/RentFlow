...
export default function ContractsPage() {
  ...
  // Filter and sort contracts with useMemo for performance
  const filteredContracts = useMemo(() => {
    ...
    if (debouncedSearchTerm) {
      filtered = filtered.filter(
        (contract) =>
          contract.tenantName.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
          contract.room.name.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
          contract.tenantEmail?.toLowerCase().includes(debouncedSearchTerm.toLowerCase()) ||
          contract.room.address?.toLowerCase().includes(debouncedSearchTerm.toLowerCase())
      );
    }
    ...
    return filtered;
  }, [contracts, debouncedSearchTerm, statusFilter, sortBy, sortOrder]);
